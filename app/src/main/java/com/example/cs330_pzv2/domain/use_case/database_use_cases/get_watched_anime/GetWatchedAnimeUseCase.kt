package com.example.cs330_pzv2.domain.use_case.database_use_cases.get_watched_anime
...
class GetWatchedAnimeUseCase @Inject constructor(
    private val repository: AnimeDatabaseRepository
) {

    operator fun invoke(): Flow<List<AnimeDetail>> {
        return repository.getWatchedAnimeDetails()
    }
