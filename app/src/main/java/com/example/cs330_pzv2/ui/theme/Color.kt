...
val md_theme_light_primary = Color(0xFF008000)
val md_theme_light_onPrimary = Color(0xFF000000)
val md_theme_light_primaryContainer = Color(0xFF006400)
val md_theme_light_onPrimaryContainer = Color(0xFFFFFFFF)
val md_theme_light_secondary = Color(0xFF008000)
val md_theme_light_onSecondary = Color(0xFF000000)
val md_theme_light_secondaryContainer = Color(0xFF006400)
val md_theme_light_onSecondaryContainer = Color(0xFFFFFFFF)
val md_theme_light_tertiary = Color(0xFF008000)
val md_theme_light_onTertiary = Color(0xFF000000)
val md_theme_light_tertiaryContainer = Color(0xFF006400)
...
val md_theme_light_inverseOnSurface = Color(0xFF008000)
val md_theme_light_inverseSurface = Color(0xFF000000)
val md_theme_light_inversePrimary = Color(0xFF008000)
val md_theme_light_shadow = Color(0xFF000000)
val md_theme_light_surfaceTint = Color(0xFF008000)
val md_theme_light_outlineVariant = Color(0xFF808080)
val md_theme_light_scrim = Color(0xFF000000)

val md_theme_dark_primary = Color(0xFF008000)
val md_theme_dark_onPrimary = Color(0xFF000000)
val md_theme_dark_primaryContainer = Color(0xFF006400)
val md_theme_dark_onPrimaryContainer = Color(0xFFFFFFFF)
val md_theme_dark_secondary = Color(0xFF008000)
val md_theme_dark_onSecondary = Color(0xFF000000)
val md_theme_dark_secondaryContainer = Color(0xFF006400)
val md_theme_dark_onSecondaryContainer = Color(0xFFFFFFFF)
val md_theme_dark_tertiary = Color(0xFF008000)
val md_theme_dark_onTertiary = Color(0xFF000000)
val md_theme_dark_tertiaryContainer = Color(0xFF006400)
...
val md_theme_dark_onSurfaceVariant = Color(0xFF808080)
val md_theme_dark_outline = Color(0xFF000000)
val md_theme_dark_inverseOnSurface = Color(0xFF008000)
val md_theme_dark_inverseSurface = Color(0xFFFFFFFF)
val md_theme_dark_inversePrimary = Color(0xFF008000)
val md_theme_dark_shadow = Color(0xFF000000)
val md_theme_dark_surfaceTint = Color(0xFF008000)
